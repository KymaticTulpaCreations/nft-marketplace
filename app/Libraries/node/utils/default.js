...
function getWeb3(NETWORK) {
  ...
  } else if(NETWORK == "goldx") {

    return new Web3(new Web3.providers.HttpProvider(GENESYS_RPC_URL.MAINNET));
  ...
  if (NETWORK == "bsc") {
    ...
    return Common.default.forCustomChain(
      "mainnet",
      {
        ...
        networkId: GENESYS_NETWORK.MAINNET_CHAIN,
        chainId: GENESYS_NETWORK.MAINNET_CHAIN,
      },
      "petersburg"
    );
...
function getChainId(NETWORK) {
  if (NETWORK == "bsc") {
    ...
    return GENESYS_NETWORK.MAINNET_CHAIN;
  } else {
